...
def main(file_path: str, year: str, start_month: str, end_month: str, result_json_path: Path) -> None:
    """
    browser action
    :param file_path:
    :param year:
    ...
    for key in id_list:
        ...
        if page_num > 200:
            ...
            for n in range(int(page_num / 200)):
    ...
    get_info = function() {
      ...
      return json;
        ...
        save_json(result_json, Path(result_json_path))
...
# print(id_list)
# for d in id_list:
# main('商品参数导出.csv', '2021', '1', '12', r'D:\github\get_customs_data\result_data_json.json')
